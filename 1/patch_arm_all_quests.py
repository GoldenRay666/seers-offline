"""Patch ARM v3 — skip ALL guide step handlers except character creation.

Keeps: guideSelectMainSprite, guideSelectMainSpriteDialog (char creation)
Skips: ALL guidePress*/guideTake*/guideSubmit*/guideShow*/guideWalk*/guideQuest*
by patching them to BX LR.
"""
import struct
...
# All GameGuideManager step handlers from IDA — patch all except char creation
PATCHES = [
    ...
    (0x46eae0, "guidePressToStorage"),
    (0x46ea54, "guidePressForBattle"),
    (0x46e9c8, "guidePressSetFirst"),
