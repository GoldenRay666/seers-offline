"""Patch ARM: skip quest-related guide steps that trigger gray screen.

gameTakeQuest @ 0x46f92e → BX LR
"""
import struct
...
PATCHES_2 = [
    (0x46f97c, "GameGuideManager::guideWalkToEva"),      # already patched in .arm_working
    (0x46f92e, "GameGuideManager::guideTakeQuest"),       # accept quest → gray screen
    (0x46e8ca, "GameGuideManager::guideQuestCenterDialog"), # quest dialog guidance
    (0x46e918, "GameGuideManager::guidePressQuestCenter"),  # press quest center
]
