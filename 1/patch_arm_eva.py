"""Patch for ARM: skip guideWalkToEva to advance guide past walk step.

GameGuideManager::guideWalkToEva @ 0x46f97c → BX LR
Skips the auto-walk and immediately advances to the next guide step (Eva dialog).
ARM doesn't need Houdini patches — all GuideLayer functions work correctly.
"""
import struct

INPUT  = r"C:\javatools\1\lib\armeabi\libgame_logic.so.bak"
