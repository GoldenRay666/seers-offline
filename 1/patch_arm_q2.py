"""arm_working + guideTakeQuest + guideShowFunctionButtons + guideElectricityHint."""
import struct
...
PATCHES = [
    (0x46f97c, "guideWalkToEva"),       # already in arm_working
    (0x46f92e, "guideTakeQuest"),        # quest acceptance
    (0x46f8de, "guideShowFunctionButtons"), # show function bar
    (0x46f74c, "guideElectricityHint"),   # energy hint after quest
]
