"""Patch ARM: only walkToEva + 6 most likely quest gray-screen culprits.

Keeps ALL character creation guide functions intact.
"""
import struct
...
# Carefully selected: only quest/feature/tutorial guides, NOT char creation
PATCHES = [
    ...
    (0x46e878, "showDoctorEvaOnGuideLayer"),
]
